...
LIST_ALBUMS = {
    "1": {"field_order": ["1"], "message_typedef": {"1": {"type": "int"}}, "type": "message"},
    "2": {"field_order": ["3", "4", "5"], "message_typedef": {"3": {"type": "string"}, "4": {"type": "string"}, "5": {"type": "int"}}, "type": "message"},
}

GET_ALBUM_MEDIA = {
    "1": {"type": "string"},
    "2": {"field_order": ["1"], "message_typedef": {"1": {"type": "int"}}, "type": "message"},
    "3": {"field_order": ["3", "4", "5"], "message_typedef": {"3": {"type": "string"}, "4": {"type": "string"}, "5": {"type": "int"}}, "type": "message"},
}
